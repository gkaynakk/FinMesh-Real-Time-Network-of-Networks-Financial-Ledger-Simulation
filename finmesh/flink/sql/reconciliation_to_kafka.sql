...
CREATE TABLE reconciliation_results_v2 (
    trade_id STRING,
    has_approved_order INT,
    has_execution INT,
...
INSERT INTO reconciliation_results_v2
...
SELECT
    ...
    CASE
        WHEN MAX(settlement_failed) = 1 THEN 'SETTLEMENT_FAILED'

        WHEN MAX(custody_blocked) = 1 THEN 'CUSTODY_BLOCKED'
