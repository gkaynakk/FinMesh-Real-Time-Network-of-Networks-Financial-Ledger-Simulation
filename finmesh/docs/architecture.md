...
- a natural-language intelligence layer,

- a FastAPI application layer,

- and a browser-based investigation and analytics interface.
...
BANK -->|raw\.trade\_orders| RP

RP --> VAL

VAL -->|approved.trade\_orders| RP

VAL -->|rejected.trade\_orders| RP

RP --> EX

EX -->|exchange.trade\_executions| RP
...
CUST -->|custody.asset\_movements| RP
